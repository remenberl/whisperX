...
VAD_SEGMENTATION_URL = "https://podwise-hh.s3.us-west-1.amazonaws.com/0b5b3216d60a2d32fc086b47ea8c67589aaeb26b7e07fcbe620d6d0b83e209ea/whisperx-vad-segmentation.bin"
...
class Binarize:
    ...
    def __call__(self, scores: SlidingWindowFeature):
        ...
        intervals = []
        weights = []
        for _, k_scores in enumerate(scores.data.T):
            # initial state
            start = timestamps[0]
            ...
            for t, y in zip(timestamps[1:], k_scores[1:]):
                ...
                if is_active: 
                    ...
                    if curr_duration > self.max_duration:
                        search_after = len(curr_scores) // 4 
                        # divide segment
...
def merge_intervals(intervals, weights, chunk_size, min_drop_duration, pad=0.0):
    ...
    for index, _ in sorted_weights:
        ...
        # Index of left-most interval after merge. 
        merged_start = left[-1][0]
        # Index of right-most interval after merge. 
        merged_end = right[-1][1]
        # Checks duration if merged.
        if intervals[merged_end][1] - intervals[merged_start][0] > chunk_size:
            continue
        intervals[merged_start][2] = (merged_start, merged_end)
        intervals[merged_end][2] = (merged_start, merged_end)
